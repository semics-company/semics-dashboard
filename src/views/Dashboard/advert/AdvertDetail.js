...
import {
    ...
    CardHeader,
    CardTitle,
    Media, Button, UncontrolledCollapse, ListGroup, ListGroupItem, Badge
} from "reactstrap"
...
import VisitTable1 from "./table/VisitTable"
import ReactPlayer from "react-player"
import AdvertChart from "./Chart/AdvertChart"
...
const AdvertDetail = () => {
    const [advertkide, setadvertkinde] = useState("image")
    ...
    const basicData = [
        ...
        {
            title: 'Third step',
            content: 'At last you can finalize your advert from here, we will show your advert after finish this part!'
        }
    ]
        ...
        <div style={{margin:"28px"}}>
            ...
            <Row className='invoice-preview'>
                <Col xl={9} md={8} sm={12}>
                    <Row>
                        <Col xl='3' md='4' sm='6'>
                            <StatsVertical icon={<Eye size={21} />} color='info' stats='36.9k' statTitle='Visit count' />
                        </Col>
                        <Col xl='3' md='4' sm='6'>
                            <StatsVertical icon={<MessageSquare size={21} />} color='warning' stats='12k' statTitle='Visit day' />
                        </Col>
                        <Col xl='3' md='4' sm='6'>
                            <StatsVertical icon={<ShoppingBag size={21} />} color='danger' stats='97.8k' statTitle='Visit from' />
                        </Col>
                        <Col xl='3' md='4' sm='6'>
                            <StatsVertical icon={<Heart size={21} />} color='primary' stats='26.8' statTitle='Visit to' />
                        </Col>
                    </Row>

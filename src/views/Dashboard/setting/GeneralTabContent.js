...
const GeneralTabs = () => {
  ...
  const [avatar, setAvatar] = useState('http://localhost:3000/static/media/avatar-s-11.1d46cc62.jpg')
        ...
        <Row>
          ...
          <Col sm='6'>
            <FormGroup>
              ...
              <Controller
                defaultValue={"mahdibahrami@gmail.com"}
                control={control}
                as={Input}
                type='email'
                id='email'
